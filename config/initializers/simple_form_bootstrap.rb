...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.use :error, wrap_with: { tag: 'span', class: 'col-md-4 help-block' }
  end
  ...
  config.wrappers :horizontal_input_with_text, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label, class: 'col-md-2 control-label'
